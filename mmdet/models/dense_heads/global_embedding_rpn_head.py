...
class GlobalEmbeddingRPNHead(BaseModule):
    ...
    def __init__(self,
        ...
        super(GlobalEmbeddingRPNHead, self).__init__(init_cfg)
    ...
    def init_weights(self):
        ...
        image.
        """
        super(GlobalEmbeddingRPNHead, self).init_weights()
    ...
    def forward_dummy(self, img, anatomy, img_metas):
        ...
        return proposals, init_proposal_features, global_features_embed, imgs_whwh
