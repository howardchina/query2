...
class Query2(TwoStageDetector):
    ...
    def __init__(self, *args, **kwargs):
        super(Query2, self).__init__(*args, **kwargs)
        assert self.with_rpn, 'Query2 do not support external proposals'
    ...
    def forward_train(self,
        ...
        proposal_boxes, proposal_features, proposal_global_box, proposal_global_features, imgs_whwh = \
    ...
    def show_result(self,
        ...
        if isinstance(result, tuple):
            if len(result) == 4: # show query2
                bbox_result, segm_result, glob_result, glob_bbox_result = result
            elif len(result) == 3: # show glob
        ...
        if glob_bbox_result is not None:
            glob_bbox_result = glob_bbox_result.cpu().detach().numpy()
        ...
        img = imshow_det_bboxes(
            ...
            out_file=out_file,
            globs=globs,
            glob_bbox_result=glob_bbox_result)
