...
from .condquery_roi_head import CondQueryRoIHead
from .query_glob_roi_head import QueryGlobRoIHead
from .query2_roi_head import Query2RoIHead
...
__all__ = [
    ...
    'FeatureRelayHead', 'GlobalContextHead', 'QueryRoIHead', 'QueryGlobRoIHead',
    'Query2RoIHead'
]
