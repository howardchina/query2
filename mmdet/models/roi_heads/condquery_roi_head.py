...
class CondQueryRoIHead(QueryRoIHead):
    def _bbox_forward(self, stage, x, rois, object_feats, img_metas, anatomy=None):
    ...
    def aug_test(self,
        ...
        for x, proposal_boxes, proposal_features, img_metas, imgs_whwh, anatomy in \
            zip(aug_x, aug_proposal_boxes, aug_proposal_features, aug_img_metas, aug_imgs_whwh, anatomies):
    ...
    def forward_dummy(self, x, proposal_boxes, proposal_features, img_metas, anatomy=None):
