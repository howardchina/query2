...
class GlobDIIHead(BBoxHead):
    ...
    def __init__(self,
        ...
        super(GlobDIIHead, self).__init__(
    ...
    def init_weights(self):
        ...
        super(GlobDIIHead, self).init_weights()
    ...
    def forward(self, roi_feat, proposal_feat, global_feat):
        ...
        for glb_layer in self.glb_fcs:
            glb_feat = glb_layer(glb_feat)

        cls_score = self.fc_cls(cls_feat).view(N, num_proposals, -1)
        bbox_delta = self.fc_reg(reg_feat).view(N, num_proposals, -1)
        global_score = self.fc_glb(glb_feat).view(N, 1, -1)

        return cls_score, bbox_delta, global_score, obj_feat.view(N, num_proposals, -1), global_feat.view(N, 1, -1), attn_feats
