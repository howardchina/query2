...
data = dict(
    ...
    train=dict(
        type='AnatomyDataset',
        ann_file=
        '/mnt/home1/workspace2/QueryInst/data/usd489/annotations/train_w_anatomy.json',
        img_prefix='/mnt/home1/workspace2/QueryInst/data/usd489/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(type='LoadAnatomy'),
    ...
    val=dict(
        type='AnatomyDataset',
        ann_file=
        '/mnt/home1/workspace2/QueryInst/data/usd489/annotations/val_w_anatomy.json',
        img_prefix='/mnt/home1/workspace2/QueryInst/data/usd489/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnatomy'),
