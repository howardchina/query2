...
data_root = '/mnt/home1/workspace2/QueryInst/data/usd514_jpeg_raw'
split = 'split_4'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='AnatomyDataset',
        ann_file=data_root+'/annotations/train_anno_'+split+'.json',
        img_prefix=data_root+'/images/',
        pipeline=train_pipeline,
        classes=('lmym', 'GIST')),
    val=dict(
        type='AnatomyDataset',
        ann_file=data_root+'/annotations/val_anno_'+split+'.json',
        img_prefix=data_root+'/images/',
